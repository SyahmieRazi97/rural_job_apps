...
import 'package:rural_jobs_app/ForgetPassword/forgetpassword_screen.dart';
import 'package:rural_jobs_app/Services/global_methods.dart';
import 'package:rural_jobs_app/SignUpPage/signup_screen.dart';
                                ...
                                children: [
                                  ...
                                  TextSpan(recognizer: TapGestureRecognizer()
                                    ..onTap = () => Navigator.push(context, MaterialPageRoute(builder: (context) => SignUp())),
                                      text: 'SignUp',
                                      style: const TextStyle(color: Colors.greenAccent,fontFamily: 'GrotleyRegular',fontWeight: FontWeight.bold, fontSize: 16,)
                                  )
                                ]
                            ),
                          ),
