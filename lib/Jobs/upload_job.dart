...
import 'package:rural_jobs_app/Persistent/persistent.dart';
...
void _uploadJob() async
{
  ...
  if(isValid)
  {
    if(_jobTitleController.text == 'Insert your title job' || _jobCategoryController.text == 'Choose job category')
    {
      GlobalMethods.showErrorDialog(error: 'Please fill the form', ctx: context);
      return;
    }
                      ...
                      child: Form(key: _formKey,
                        child: Column(
                          ...
                          children: [
                            ...
                            _textFormFields(valueKey: 'JobCategory',
                            ...
                            _textFormFields(valueKey: 'JobTitle',
                              controller: _jobTitleController, enabled: true,
                              fct: (){}, maxLength: 100,
                            ),
                            _textTitles(label: 'Job Description :'),
                            _textFormFields(valueKey: 'JobDescription',
                              controller: _jobDescController, enabled: true,
                              fct: (){}, maxLength: 10000,
                            ),
                          ],
                        ),
