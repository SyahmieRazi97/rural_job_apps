...
import 'package:rural_jobs_app/Search_Jobs/search_jobs2.dart';
import 'package:rural_jobs_app/Widgets/botttom_nav_bar.dart';
        ...
        {return AlertDialog(
            ...
            content: Container(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (ctx, index)
                  {
                    return InkWell(
                      onTap: (){
                        setState(() {jobCategoryFilter = Persistent.jobCategoryList[index];});
            ...
            actions: [
              ...
              TextButton(
                onPressed: ()
                {
                  setState(() {jobCategoryFilter = null;});
                  Navigator.canPop(context) ? Navigator.pop(context) : null;
                },
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('All Jobs', style: TextStyle(fontFamily: 'Signatra', fontSize: 40,),),
          centerTitle: true,
          ...
          actions: [
            IconButton(icon: const Icon(Icons.search_outlined, color: Colors.black,),
              onPressed: ()
              {
